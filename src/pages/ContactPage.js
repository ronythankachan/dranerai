...
class ContactPage extends React.Component {
    ...
    handleSubmit(e) {
        ...
        axios({method: 'post', url: 'http://localhost:5000/api/send_mail', data: data}).then(response => {
                            ...
                            <Col>
                                <Form.Group controlId="firstName" className="mt-3">
                                    ...
                                    <Form.Control type="text" placeholder="First Name"
                                        ...
                                        onChange={
                                            this.handleChange.bind(this, 'firstName')
                                        }
                                        required/>
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Group controlId="lastName" className="mt-3">
                                    ...
                                    <Form.Control type="text" placeholder="Last Name"
                                        ...
                                        onChange={
                                            this.handleChange.bind(this, 'lastName')
                                        }
                                        required/>
                                </Form.Group>
                            </Col>
